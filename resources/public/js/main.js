...
document.write("<script>if (typeof goog != \"undefined\") { goog.require(\"figwheel.connect.build_development\"); }</script>");
document.write('<script>goog.require("space_adventure.core");</script>');
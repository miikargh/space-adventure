...
var or__30083__auto__ = goog.object.get(goog.global,"FIGWHEEL_WEBSOCKET_CLASS");
if(cljs.core.truth_(or__30083__auto__)){
return or__30083__auto__;
} else {
var or__30083__auto____$1 = goog.object.get(goog.global,"WebSocket");
...
}catch (e39423){if((e39423 instanceof Error)){
var e = e39423;
return null;
} else {
throw e39423;
...
var and__30071__auto__ = cljs.core.map_QMARK_.call(null,msg);
if(and__30071__auto__){
var and__30071__auto____$1 = new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg);
if(cljs.core.truth_(and__30071__auto____$1)){
var and__30071__auto____$2 = cljs.core.not_EQ_.call(null,new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg),new cljs.core.Keyword(null,"ping","ping",-1670114784));
...
figwheel.client.socket.open = (function figwheel$client$socket$open(p__39424){
var map__39425 = p__39424;
var map__39425__$1 = ((((!((map__39425 == null)))?((((map__39425.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__39425.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__39425):map__39425);
var opts = map__39425__$1;
var retry_count = cljs.core.get.call(null,map__39425__$1,new cljs.core.Keyword(null,"retry-count","retry-count",1936122875));
var retried_count = cljs.core.get.call(null,map__39425__$1,new cljs.core.Keyword(null,"retried-count","retried-count",-2127867357));
var websocket_url = cljs.core.get.call(null,map__39425__$1,new cljs.core.Keyword(null,"websocket-url","websocket-url",-490444938));
var build_id = cljs.core.get.call(null,map__39425__$1,new cljs.core.Keyword(null,"build-id","build-id",1642831089));
...
socket.onclose = ((function (url,socket,WebSocket,temp__5455__auto__,map__39425,map__39425__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
var retried_count__$1 = (function (){var or__30083__auto__ = retried_count;
if(cljs.core.truth_(or__30083__auto__)){
return or__30083__auto__;
} else {
return (0);
...
return setTimeout(((function (retried_count__$1,url,socket,WebSocket,temp__5455__auto__,map__39425,map__39425__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (){
...
});})(retried_count__$1,url,socket,WebSocket,temp__5455__auto__,map__39425,map__39425__$1,opts,retry_count,retried_count,websocket_url,build_id))
,(function (){var x__30442__auto__ = (10000);
var y__30443__auto__ = ((2000) + ((500) * retried_count__$1));
...
socket.onerror = ((function (url,socket,WebSocket,temp__5455__auto__,map__39425,map__39425__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
//# sourceMappingURL=socket.js.map?rel=1520609268873

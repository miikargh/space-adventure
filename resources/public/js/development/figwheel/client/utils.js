...
var or__30083__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj37791 = {"detail":data};
return obj37791;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__30071__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__30071__auto__)){
var and__30071__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__37798 = cljs.core._EQ_;
var expr__37799 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__37798.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__37799))){
return ((function (pred__37798,expr__37799){
return (function (p1__37792_SHARP_){
return console.warn(p1__37792_SHARP_);
});
;})(pred__37798,expr__37799))
} else {
if(cljs.core.truth_(pred__37798.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__37799))){
return ((function (pred__37798,expr__37799){
return (function (p1__37793_SHARP_){
return console.debug(p1__37793_SHARP_);
});
;})(pred__37798,expr__37799))
} else {
if(cljs.core.truth_(pred__37798.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__37799))){
return ((function (pred__37798,expr__37799){
return (function (p1__37794_SHARP_){
return console.error(p1__37794_SHARP_);
});
;})(pred__37798,expr__37799))
} else {
return ((function (pred__37798,expr__37799){
return (function (p1__37795_SHARP_){
return console.log(p1__37795_SHARP_);
});
;})(pred__37798,expr__37799))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__37802){
...
var eval_fn = cljs.core.get.call(null,map__37803__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__37805_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__37807,(0),null);
var v = cljs.core.nth.call(null,vec__37807,(1),null);
...
if(cljs.core.truth_((function (){var and__30071__auto__ = typeof localStorage !== 'undefined';
...
}catch (e37812){if((e37812 instanceof Error)){
var e = e37812;
return not_found;
} else {
throw e37812;
...
//# sourceMappingURL=utils.js.map?rel=1520609266505

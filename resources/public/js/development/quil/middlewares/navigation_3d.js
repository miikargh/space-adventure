...
var vec__32575 = axis;
var a_x = cljs.core.nth.call(null,vec__32575,(0),null);
var a_y = cljs.core.nth.call(null,vec__32575,(1),null);
var a_z = cljs.core.nth.call(null,vec__32575,(2),null);
var vec__32578 = v;
var x = cljs.core.nth.call(null,vec__32578,(0),null);
var y = cljs.core.nth.call(null,vec__32578,(1),null);
var z = cljs.core.nth.call(null,vec__32578,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__32581,p__32582){
var vec__32583 = p__32581;
var u1 = cljs.core.nth.call(null,vec__32583,(0),null);
var u2 = cljs.core.nth.call(null,vec__32583,(1),null);
var u3 = cljs.core.nth.call(null,vec__32583,(2),null);
var vec__32586 = p__32582;
var v1 = cljs.core.nth.call(null,vec__32586,(0),null);
var v2 = cljs.core.nth.call(null,vec__32586,(1),null);
var v3 = cljs.core.nth.call(null,vec__32586,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__32589_SHARP_){
return (p1__32589_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__32590_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__32591_SHARP_,angle_lr),angle_ud);
...
var map__32593 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__32593__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__32593__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__5455__auto__ = (function (){var pred__32595 = cljs.core._EQ_;
var expr__32596 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__32595.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__32596))){
return straight;
} else {
if(cljs.core.truth_(pred__32595.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__32596))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__32595.call(null,quil.middlewares.navigation_3d.space,expr__32596))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__32595.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__32596))){
return up;
} else {
if(cljs.core.truth_(pred__32595.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__32596))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__32595.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__32596))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__5455__auto__,map__32593,map__32593__$1,up,straight){
return (function (p1__32592_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__32592_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__5455__auto__,map__32593,map__32593__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__32598_SHARP_);
});})(initial_state))
);
});
/**
...
var map__32599_32610 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__32599_32611__$1 = ((((!((map__32599_32610 == null)))?((((map__32599_32610.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__32599_32610.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__32599_32610):map__32599_32610);
var vec__32600_32612 = cljs.core.get.call(null,map__32599_32611__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_32613 = cljs.core.nth.call(null,vec__32600_32612,(0),null);
var c_y_32614 = cljs.core.nth.call(null,vec__32600_32612,(1),null);
var c_z_32615 = cljs.core.nth.call(null,vec__32600_32612,(2),null);
var vec__32603_32616 = cljs.core.get.call(null,map__32599_32611__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_32617 = cljs.core.nth.call(null,vec__32603_32616,(0),null);
var u_y_32618 = cljs.core.nth.call(null,vec__32603_32616,(1),null);
var u_z_32619 = cljs.core.nth.call(null,vec__32603_32616,(2),null);
var vec__32606_32620 = cljs.core.get.call(null,map__32599_32611__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_32621 = cljs.core.nth.call(null,vec__32606_32620,(0),null);
var p_y_32622 = cljs.core.nth.call(null,vec__32606_32620,(1),null);
var p_z_32623 = cljs.core.nth.call(null,vec__32606_32620,(2),null);
quil.core.camera.call(null,p_x_32621,p_y_32622,p_z_32623,(p_x_32621 + c_x_32613),(p_y_32622 + c_y_32614),(p_z_32623 + c_z_32615),u_x_32617,u_y_32618,u_z_32619);
...
//# sourceMappingURL=navigation_3d.js.map?rel=1520609260399
